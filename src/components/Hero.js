...
export default function Hero() {
  ...
  return (
    <section id="herosection" className="min-h-screen flex flex-col items-center justify-between py-[50px] px-[40px] text-white overflow-x-clip sm:flex-col gap-[15px] lg:flex-row">
      ...
      {/*Texto la Izquierda*/}
      <div className="max-w-4xl order-2 sm:order-1 md:order-1 lg:order-1" data-aos="fade-right" data-aos-duration="3000">
      ...
      {/*Imagen a la derecha*/}
      <div className="w-[100%] h-[430px] sm:w-[455px] sm:h-[618px] lg:w-[450px] lg:h-[657] rounded-xl order-1 md:order-2 md:order-2 lg:order-2" data-aos="fade-left" data-aos-duration="3000">
